...
kableExtra::kbl(tabla, align = 'l', booktabs = TRUE, linesep = "", escape = FALSE,
                ...
                caption = "Método del valor crítico para la prueba de una media con varianza poblacional conocida") |>
...
kableExtra::kbl(tabla, align = 'l', booktabs = TRUE, linesep = "", escape = FALSE,
                col.names = c("Hipótesis nula", "Estadístico de prueba", "Hipótesis alternativa", "Criterio de rechazo"),
                caption = "Método del valor crítico para la prueba de una media con varianza poblacional desconocida") |>
  collapse_rows(columns = 1:2, valign = "middle") |>
  kable_styling(full_width = FALSE,
                bootstrap_options = c("condensed"),
                latex_options = c("HOLD_position", "scale_down")) |>
...
kableExtra::kbl(tabla, align = 'l', booktabs = TRUE, linesep = "", escape = FALSE,
                col.names = c("Hipótesis nula", "Estadístico de prueba", "Hipótesis alternativa", "Criterio de rechazo"),
                caption = "Método del valor crítico para la prueba de diferencia de medias con varianzas poblacionales conocidas") |>
  collapse_rows(columns = 1:2, valign = "middle") |>
  kable_styling(full_width = FALSE,
                bootstrap_options = c("condensed"),
                latex_options = c("HOLD_position", "scale_down")) |>
...
kableExtra::kbl(tabla, align = 'l', booktabs = TRUE, linesep = "", escape = FALSE,
                col.names = c("Hipótesis nula", "Estadístico de prueba", "Hipótesis alternativa", "Criterio de rechazo"),
                caption = "Método del valor crítico para la prueba de diferencia de medias con varianzas poblacionales desconocidas e iguales") |>
  collapse_rows(columns = 1:2, valign = "middle") |>
  kable_styling(full_width = FALSE,
                bootstrap_options = c("condensed"),
                latex_options = c("HOLD_position", "scale_down")) |>
...
kableExtra::kbl(tabla, align = 'l', booktabs = TRUE, linesep = "", escape = FALSE,
                col.names = c("Hipótesis nula", "Estadístico de prueba", "Hipótesis alternativa", "Criterio de rechazo"),
                caption = "Método del valor crítico para la prueba de diferencia de medias con varianzas poblacionales desconocidas y distintas") |>
  collapse_rows(columns = 1:2, valign = "middle") |>
  kable_styling(full_width = FALSE,
                bootstrap_options = c("condensed"),
                latex_options = c("HOLD_position", "scale_down")) |>
...
kableExtra::kbl(tabla, align = 'l', booktabs = TRUE, linesep = "", escape = FALSE,
                col.names = c("Hipótesis nula", "Estadístico de prueba", "Hipótesis alternativa", "Criterio de rechazo"),
                caption = "Método del valor crítico para la prueba de comparación de varianzas") |>
