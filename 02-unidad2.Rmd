...
::: {.exercise #consumidor}
Utilizando la base de datos [ICC](#ICC), estudio si hay suficiente evidencia estadística para afirmar los siguiente.
...
:::{.exercise #cuotas}
La base [*control+cuotas.csv*](https://raw.githubusercontent.com/Dfranzani/Bases-de-datos-para-cursos/main/2023-1/control%2Bcuotas.csv) contiene datos de los valores cuota de los primeros tres meses del año 2022 de las AFP Paln Vital y Provida, específicamente de un fondo A de un APV.
