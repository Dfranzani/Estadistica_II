...
\date{Actualizado al 27-03-2024}
...
\href{https://dfranzani.github.io/Estadistica_I/}{Enlace al documento del primer curso de Estadística: Estadística I \& Estadística Descriptiva}.
...
\hypertarget{intervalo-de-confianza-para-la-media}{%
\section{Intervalo de confianza para la media}\label{intervalo-de-confianza-para-la-media}}

\hypertarget{intervalo-de-confianza-para-la-media-de-una-distribuciuxf3n-normal-y-varianza-poblacional-conocida}{%
\subsection{Intervalo de confianza para la media de una distribución normal y varianza poblacional conocida}\label{intervalo-de-confianza-para-la-media-de-una-distribuciuxf3n-normal-y-varianza-poblacional-conocida}}
...
\hypertarget{intervalo-de-confianza-para-la-media-de-una-distribuciuxf3n-normal-y-varianza-poblacional-desconocida}{%
\subsection{Intervalo de confianza para la media de una distribución normal y varianza poblacional desconocida}\label{intervalo-de-confianza-para-la-media-de-una-distribuciuxf3n-normal-y-varianza-poblacional-desconocida}}

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-10}Intervalos de confianza para la media de una distribución normal y varianza poblacional desconocida}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llc}
\toprule
...
Utilizando la base de datos del \protect\hyperlink{Imacec1}{Imacec}:
...
\hypertarget{intervalo-de-confianza-para-la-diferencia-de-medias-de-dos-distribuciones-normales-y-varianzas-poblacionales-conocidas}{%
\subsection{Intervalo de confianza para la diferencia de medias de dos distribuciones normales y varianzas poblacionales conocidas}\label{intervalo-de-confianza-para-la-diferencia-de-medias-de-dos-distribuciones-normales-y-varianzas-poblacionales-conocidas}}

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-12}Intervalos de confianza para la diferencia de medias de dos distribucones normales y varianzas poblacionales conocidas}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llc}
\toprule
...
\hypertarget{intervalo-de-confianza-para-la-diferencia-de-medias-de-dos-distribuciones-normales-y-varianzas-poblacionales-desconocidas-e-iguales}{%
\subsection{Intervalo de confianza para la diferencia de medias de dos distribuciones normales y varianzas poblacionales desconocidas e iguales}\label{intervalo-de-confianza-para-la-diferencia-de-medias-de-dos-distribuciones-normales-y-varianzas-poblacionales-desconocidas-e-iguales}}

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-15}Intervalos de confianza para la diferencia de medias de dos distribucones normales y varianzas poblacionales desconocidas e iguales}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llc}
\toprule
...
\begin{exercise}
\protect\hypertarget{exr:ICcontrolcuotas}{}\label{exr:ICcontrolcuotas}La base de datos \protect\hyperlink{Cuotas}{Control cuotas} contiene los datos de los valores cuota de los primeros tres meses del año 2022 de las AFP Plan Vital y Provida. Se está interesado en saber si el valor promedio de las cuotas de Plan Vital superan al de Provida por más de 30000 pesos, para ello, elabore un intervalo de confianza, considerando una confianza del 90\%. Asuma, que el valor cuota es una variable aleatoria que distribuye normal en ambas poblaciones (independientes), y que las varianzas poblacionales son desconocidas e iguales.
\end{exercise}

\begin{exercise}
Utilizando la base de datos \protect\hyperlink{Cuotas}{Control cuotas}, estudiar si la media del valor cuota de Provida es menor a la de Plan Vital. Utilice una confianza del 99.64\% Considere distribución normal de las variables y varianzas poblacionales desconocidas e iguales.
\end{exercise}

\hypertarget{intervalo-de-confianza-para-la-diferencia-de-medias-de-dos-distribuciones-normales-y-varianzas-poblacionales-desconocidas-y-distintas}{%
\subsection{Intervalo de confianza para la diferencia de medias de dos distribuciones normales y varianzas poblacionales desconocidas y distintas}\label{intervalo-de-confianza-para-la-diferencia-de-medias-de-dos-distribuciones-normales-y-varianzas-poblacionales-desconocidas-y-distintas}}

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-16}Intervalos de confianza para la diferencia de medias de dos distribucones normales y varianzas poblacionales desconocidas y distintas}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llc}
\toprule
...
\begin{exercise}
Utilizando la base de datos del \protect\hyperlink{Imacec1}{Imacec}, elabore un intervalo de confianza para estudiar si, la media del Imacec del sector de minería es menor que el del sector de industria en el periodo 2019-2020. Asuma que, las distribuciones poblacionales son normales e indendientes, y que las varianzas poblacionales son desconocidas y distintas. Utilice una confianza del 96\%. Interprete.
\end{exercise}

\hypertarget{intervalo-de-confianza-para-la-comparaciuxf3n-de-varianzas}{%
\section{Intervalo de confianza para la comparación de varianzas}\label{intervalo-de-confianza-para-la-comparaciuxf3n-de-varianzas}}
...
\begin{exercise}
Utilizando la base de datos del \protect\hyperlink{Imacec1}{Imacec}, elabore un intervalo de confianza para comparar la variabilidad (varianza) del valor del Imacec entre ambos sectores. Asuma, que las distribuciones poblacionales son normales e independientes. Utilice una confianza del 90\%. Interprete.
\end{exercise}

\begin{exercise}
Utilizando la base de datos del \protect\hyperlink{Imacec1}{Imacec}, elabore un intervalo de confianza para estudiar la diferencia la media del Imacec de ambos sectores. Asuma, que las distribuciones poblacionales son normales e independientes. Utilice una confianza del 92\%. Interprete.
\end{exercise}

\begin{exercise}
Utilizando la base de datos del \protect\hyperlink{Imacec1}{Imacec}, elabore un intervalo de confianza para estudiar si, el promedio del Imacec de minería es mayor al de industria por al más de 2 unidades. Asuma, que las distribuciones poblacionales son normales e independientes. Utilice una confianza del 97\%. Interprete.
\end{exercise}
...
\begin{itemize}
\item
  \protect\hypertarget{Imacec2}{\href{https://raw.githubusercontent.com/Dfranzani/Bases-de-datos-para-cursos/main/2022-2/Estad\%C3\%ADstica\%201/imacec.csv}{Imacec}}: Contiene los datos de los valores del Imacec mensual de distintos sectores desde enero del 2018 hasta junio del 2022. Las columnas de la base de datos son las siguientes:
...
\section{Concepto}\label{concepto-1}}
...
\hypertarget{elaboraciuxf3n-1}{%
\subsection{Elaboración}\label{elaboraciuxf3n-1}}
...
{\centering \includegraphics{est2+inferencia_files/figure-latex/regiones3-1} 
...
{\centering \includegraphics{est2+inferencia_files/figure-latex/areas-rechazo-ud-1} 
...
{\centering \includegraphics{est2+inferencia_files/figure-latex/region-rechazo-1-1} 
...
\begin{equation}
\notag
\left(-\infty, 62 + Z_{0.99}\frac{\sqrt{6}}{\sqrt{50}}\right) = (-\infty, 62.8)
\end{equation}
...
\begin{exercise}
Un cirujano afirma que sus pacientes se recuperan en un promedio de 5 días después de una cirugía. Para probar su afirmación, un internista toma una muestra aleatoria de 20 pacientes y encuentra que la duración promedio de recuperación es de 6 días, con una desviación estándar conocida de 1.5 días. ¿Hay suficiente evidencia para rechazar la afirmación del cirujano al nivel de significancia del 10\%?
\end{exercise}
...
\hypertarget{prueba-de-hipuxf3tesis-para-la-media-de-una-distribuciuxf3n-normal-con-varianza-poblacional-desconocida}{%
\subsection{Prueba de hipótesis para la media de una distribución normal con varianza poblacional desconocida}\label{prueba-de-hipuxf3tesis-para-la-media-de-una-distribuciuxf3n-normal-con-varianza-poblacional-desconocida}}
...
\begin{table}[H]
\centering
\caption{\label{tab:unamedia2}Criterios de rechazo para la prueba de una media con varianza poblacional desconocida}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llll}
\toprule
...
\tightlist
\item
  \(\mu:\) Media del Imacec de Minería en el periodo 01/2018 - 06/2022.
\end{itemize}
...
El estadístico reportado es \(t = -1.27373\) con un valor-p de 0.8965, el cual, al ser mayor a la significancia de 0.1, implica que no existe suficiente evidencia estadística para rechazar \(H_0\), por lo que se asume que, el valor promedio del Imacec del sector de Minería no es mayor a 98.54167.
...
\tightlist
\item
  \(\mu:\) Media del Imacec de Industria en el periodo 01/2018 - 06/2022.
\end{itemize}
...
El estadístico reportado es \(t = 1.3678\) con un valor-p de 0.08857, el cual, al ser menor a la significancia de 0.1, implica que existe suficiente evidencia estadística para rechazar \(H_0\), por lo que se asume que, el valor promedio del Imacec del sector de Industria es mayor a 98.54167.

Utilizando el intervalo de confianza \((98.6, \infty)\), se observa que el valor de \(\mu_0 = 98.54\) no se encuentra dentro del intervalo, por ende, existe suficiente evidencia estadística para rechazar \(H_0\), obteniéndose la misma conclusión que al usar el valor-p.
\end{example}

\begin{exercise}
Utilizando la base de datos \protect\hyperlink{Imacec2}{Imacec}, establezca si hay suficiente evidencia estadística para afirmar que, el valor promedio del Imacec de cada sector durante el año 2022 es mayor 96.89167. Establezca las hipótesis, estadísticos y criterios de rechazo. Utilice una significancia del 7\%. Además, asuma que las variables distribuyen normal y tienen varianza poblacional desconocida. Concluya.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:consumidor}{}\label{exr:consumidor}Utilizando la base de datos \protect\hyperlink{ICC}{ICC}, estudio si hay suficiente evidencia estadística para afirmar los siguiente.
...
\begin{table}[H]
\centering
\caption{\label{tab:dosmedias1}Criterios de rechazo para la prueba de de diferencia de medias con varianzas poblacionales conocidas}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llll}
\toprule
...
El valor-p asociado al estadístico de prueba es

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{valor.p }\OtherTok{=} \DecValTok{2}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\FunctionTok{pnorm}\NormalTok{(}\FunctionTok{abs}\NormalTok{(z0)))}
\NormalTok{valor.p}
\end{Highlighting}
\end{Shaded}
...
Luego, este valor es menor a la significancia del 5\%, por lo que existe suficiente evidencia estadística para rechazar \(H_0\), es decir, existe suficiente evidencia para apoyar la afirmación de que existe diferencia entre los gastos de alimentación promedio entre las familias de ambas ciudades.

Por otro lado, usando el método de valor crítico se obtiene que
...
el valor absoluto del estadístico de prueba es mayor al valor crítico, obteniéndose la misma interpretación que al utilizar el valor-p.
\end{example}

\begin{exercise}
\protect\hypertarget{exr:cuotas}{}\label{exr:cuotas}La base \href{https://raw.githubusercontent.com/Dfranzani/Bases-de-datos-para-cursos/main/2023-1/control\%2Bcuotas.csv}{\emph{control+cuotas.csv}} contiene datos de los valores cuota de los primeros tres meses del año 2022 de las AFP Paln Vital y Provida, específicamente de un fondo A de un APV.

Se está interesado en saber si, el valor promedio de las cuotas de Plan Vital superan al de Provida por más de 30000 pesos. Considere una confianza del 99\%. Plantee y pruebe una hipótesis para la diferencia de medias, considerando \(\sigma^2_{\text{Provida}} = 1165833\) y \(\sigma^2_{\text{Plan Vital}} = 3393141\). Utilice el método del valor-p e intervalo de confianza.
\end{exercise}
...
\begin{table}[H]
\centering
\caption{\label{tab:dosmedias2}Criterios de rechazo para la prueba de de diferencia de medias con varianzas poblacionales desconocidas e iguales}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llll}
\toprule
...
\begin{example}
\protect\hypertarget{exm:consumidor}{}\label{exm:consumidor}Considere la base de datos \protect\hyperlink{ICC}{ICC}. Se está interesado en saber si el valor promedio del ICC en Alemania menos el de Francia es menor a 1.1. Elabore una prueba de hipótesis para analizar este interés con un 90\% de confianza. Concluya utilizando el valor -- p.~Además, que las varianzas poblaciones son iguales.
...
\FunctionTok{t.test}\NormalTok{(}\AttributeTok{x =}\NormalTok{ ICC\_Alemania,}
...
Con un valor -- p de 0.5417 mayor a 0.1, no existe suficiente evidencia estadística para rechazar \(H_0\), por lo que, no se asume que la diferencia del ICC promedio entre Alemania y Francia sea menor a 1.1 puntos.

Similar a las pruebas de una media, para rechazar \(H_0\) mediante el intervalo de confianza se debe verificar que el valor de \(\delta_0\) se encuentra fuera del intervalo. En este caso, se aprecia que el \(\delta_0\) de 1.1 está contenido por el intervalo de confianza, por lo que no se rechazaría \(H_0\), lo cual va en línea con lo anteriormente concluido.
\end{example}

\begin{exercise}
Utilizando la base de datos \protect\hyperlink{ICC}{ICC}, plantee y pruebe un hipótesis, para verificar si para el año 2019 existe una diferencia mayor a 1.2 entre el ICC promedio de Polonia e Italia, con una confianza del 93\%. Utilice el método del intervalo de confianza. Además, asuma que las varianzas poblacionales son desconocidas e iguales.
\end{exercise}
...
\begin{table}[H]
\centering
\caption{\label{tab:dosmedias3}Criterios de rechazo para la prueba de de diferencia de medias con varianzas poblacionales desconocidas y distintas}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llll}
\toprule
...
\begin{example}
Utilizando la base de datos del \protect\hyperlink{ICC}{ICC}, establecer una prueba de hipótesis para verificar si el ICC promedio de Italia es mayor al de Francia, con una significancia del 3\%. Asumiendo que las varianzas poblacionales son desconocidas y distintas.
...
\NormalTok{ICC\_Francia }\OtherTok{=}\NormalTok{ datos}\SpecialCharTok{$}\NormalTok{ICC[datos}\SpecialCharTok{$}\NormalTok{Locacion }\SpecialCharTok{==} \StringTok{"FRA"}\NormalTok{] }\CommentTok{\# Valores del ICC de Francia}
\FunctionTok{t.test}\NormalTok{(}\AttributeTok{x =}\NormalTok{ ICC\_Italia,}
       \AttributeTok{y =}\NormalTok{ ICC\_Francia,}
...
Con un valor-p menor a la significancia del (3\%), existe suficiente evidencia estadística para rechazar \(H_0\), es decir, existe suficiente evidencia estadística para apoyar la afirmación de que el ICC promedio de Italia es mayor al de Francia.

Observando el intervalo de confianza se verifica que \(\delta_0\) no se encuentra dentro del intervalo, por lo que se rechaza \(H_0\), obteniéndose la misma conclusión antes mencionada.
\end{example}
...
\begin{table}[H]
\centering
\caption{\label{tab:varianzas}Criterios de rechazo para la prueba de comparación de varianzas}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{llll}
\toprule
...
\begin{example}
Utilizando la base de datos del \protect\hyperlink{ICC}{ICC}, establecer una prueba de hipótesis para verificar si el ICC promedio de España es distinto al de Polonia, con una significancia del 4\%. Asumiendo muestras independientes.
...
Con un valor-p menor a la significancia, se asume que las varianzas poblacionales son distintas, es decir, se rechaza \(H_0\). Por lo tanto, se procede a realizar un prueba para la diferencia de medias, asumiendo que las varianzas poblacionales son desconocidas y distintas.

Para utilizar el intervalo de confianza como método de rechazo, se debe verificar que el 1 no está contenido por el intervalo de confianza para rechazar \(H_0\).

Las hipótesis para la diferencia de medias son las siguientes.
...
Con un valor-p de 0.14 mayor a la significancia (4\%), no existe suficiente evidencia estadística para rechazar \(H_0\), es decir, no existe suficiente evidencia estadística para apoyar la afirmación de que el ICC entre ambos países es distinto.

De igual manera, al observar el intervalo de confianza, se verifica que el valor de \(\delta_0\) se encuentra del intervalo, obteniéndose la misma conslusión antes dada.
\end{example}
...
\item
  ...
  \end{itemize}
\item
  \protect\hypertarget{Imacec3}{\href{https://raw.githubusercontent.com/Dfranzani/Bases-de-datos-para-cursos/main/2022-2/Estad\%C3\%ADstica\%201/imacec.csv}{Imacec}}: Contiene los datos de los valores del Imacec mensual de distintos sectores desde enero del 2018 hasta junio del 2022. Las columnas de la base de datos son las siguientes:
...
\section{Análisis descriptivo de datos}\label{descriptiva}}

\hypertarget{gruxe1ficos-descriptivos}{%
\subsection{Gráficos descriptivos}\label{gruxe1ficos-descriptivos}}
...
Para generar un histograma en R a partir de un conjunto de datos, se utiliza el siguiente código (se toma como ejemplo la base de datos \protect\hyperlink{TasaEURUSD}{Tasa Euro/Dólar}):
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-55-1} \end{center}
...
\begin{exercise}
Utilizando la base de datos de \protect\hyperlink{PreciosElectricidad}{Precios}, elabore un histograma de los precios de la electricidad. Interprete.
\end{exercise}

\hypertarget{gruxe1fico-de-caja}{%
\subsubsection{Gráfico de Caja}\label{gruxe1fico-de-caja}}
...
\item
  Las lineas que se extienden verticalmente desde la caja se les llaman \emph{`bigotes'}. Los bigotes van desde los extremos de la caja hasta los valores menor y mayor de los límites calculados en el paso 3.
\item
  Mediante puntos se indica la localización de las observaciones atípicas.
\end{enumerate}

Para generar un gráfico de caja en R a partir de un conjunto de datos, se utiliza el siguiente código (se toma como ejemplo la base de datos \protect\hyperlink{TasaEURUSD}{Tasa Euro/Dólar}):
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-57-1} \end{center}
...
\begin{exercise}
Utilizando la base de datos de \protect\hyperlink{PreciosElectricidad}{Precios}, elabore un gráfico de caja de los precios de la electricidad. Interprete.
\end{exercise}

\hypertarget{gruxe1fico-de-violuxedn}{%
\subsubsection{Gráfico de Violín}\label{gruxe1fico-de-violuxedn}}
...
Para generar un gráfico de violín en R a partir de un conjunto de datos, se utiliza el siguiente código (se toma como ejemplo la base de datos \protect\hyperlink{TasaEURUSD}{Tasa Euro/Dólar}):
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-58-1} \end{center}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-59-1} \end{center}
...
\begin{exercise}
Utilizando la base de datos de \protect\hyperlink{PreciosElectricidad}{Precios}, elabore un gráfico de violín con caja y promedio de los precios de la electricidad. Interprete.
\end{exercise}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-60-1} \end{center}
...
\begin{exercise}
\protect\hypertarget{exr:violin-colesterol-azucar}{}\label{exr:violin-colesterol-azucar}Utilizando la base de datos de \protect\hyperlink{Pacientes}{Paciente} Realice un gráfico de violín con caja y promedio del nivel de colesterol de los paciente, diferenciando por el nivel de azúcar en sangre en ayunas. Interprete.
\end{exercise}
...
\begin{exercise}
Utilizando la base de datos de \protect\hyperlink{PreciosElectricidad}{Precios}, realice un gráfico de violín con caja y promedio para el precio de la electricidad, diferenciado por año. Interprete.
\end{exercise}
...
Para generar un gráfico de barras en R a partir de un conjunto de datos, se utiliza el siguiente código (se toma como ejemplo la base de datos \protect\hyperlink{TasaEURUSD}{Tasa Euro/Dólar}):
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-61-1} \end{center}
...
\begin{exercise}
Utilizando la base de datos \protect\hyperlink{Pacientes}{Pacientes}, elabore un gráfico de barras de la variable \emph{fbs}. Interprete, apoyado de una tabla de frecuencias absolutas.
\end{exercise}

\begin{exercise}
Utilizando la base de datos \protect\hyperlink{Pacientes}{Pacientes}, elabore un gráfico de barras (no apiladas) de la variable \emph{cp}, diferenciado por sexo. Interprete, apoyado de una tabla de frecuencias relativas porcentuales. Haga el contraste visual con el gráfico de barras apiladas.
\end{exercise}
...
Para generar un gráfico de dispersión en R a partir de un conjunto de datos, se utiliza el siguiente código (se toma como ejemplo la base de datos \protect\hyperlink{TasaEURUSD}{Tasa Euro/Dólar}):
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-62-1} \end{center}
...
\begin{exercise}
Utilizando la base de datos \protect\hyperlink{Pacientes}{Pacientes}, realice un gráfico de dispersión entre la variable \emph{age} (eje X) y la variable \emph{thalachh} (eje Y). Interprete.
\end{exercise}

\begin{example}

En los siguiente gráficos se toma como ejemplo la base de datos \protect\hyperlink{TasaEURUSD}{Tasa Euro/Dólar}.
...
\end{Shaded}
  ...
  \begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-63-1} \end{center}
\item
...
\end{Shaded}
  ...
  \begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-64-1} \end{center}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-65-1} \end{center}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-66-1} \end{center}
...
Utilizando la base de datos de la \protect\hyperlink{TasaEURUSD}{Tasa Euro/Dólar}:
...
\begin{exercise}
Utilizando la base de datos de \protect\hyperlink{PreciosElectricidad}{Precios de electricidad}, elabore un gráfico de dispersión del precio de la electricidad a través del tiempo (considere año, mes y día). Interprete.
\end{exercise}

\begin{exercise}

Utilizando la base de datos de \protect\hyperlink{Pacientes}{Pacientes}:
...
\textbf{Nota:} En R, se utiliza el comando \texttt{cov()} para calcular covarianza entre dos variables.
\end{example}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-67-1} \end{center}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-68-1} \end{center}

\textbf{Nota:} En R, se utiliza el comando \texttt{cor()} para calcular covarianza entre dos variables.
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-71-1} \end{center}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-72-1} \end{center}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-75-1} \end{center}
...
Utilizando la base de datos \protect\hyperlink{Ingreso}{Ingreso}:
...
\hypertarget{sumas-cuadruxe1ticas}{%
\subsection{Sumas cuadráticas}\label{sumas-cuadruxe1ticas}}
...
\hypertarget{pruebasHipotesisRLS}{%
...
\item
  La segunda columna (\textbf{Std. Error}) corresponde a la desviación estándar de la estimación de cada uno de los betas. Como cada uno de los errores (\(\epsilon_i\)) tiene distribución normal, esto implica que cada uno de los \(\beta\) tenga distribución t -- Student (no analizaremos esto en profundidad).
\item
...
\item
  Finalmente, se calcula el valor - p asociado a cada una de las hipótesis del punto anterior, con la fórmula \(2\cdot(1-pt(|t_0|, n-1))\). El valor resultante de esta expresión para cada uno de los betas se encuentra en la columna \textbf{Pr(\textgreater\textbar t\textbar)}. La interpretación de este valor es mediante el criterio del valor - p presentado en la unidad anterior.
\end{itemize}
...
Utilizando la base de datos \protect\hyperlink{Pacientes}{Pacientes}:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Ajuste un modelo para estudiar el nivel de colesterol de los pacientes a partir de su edad. Luego, estudie las pruebas de hipótesis asociadas.
\item
  Ajuste un modelo para estudiar el tiempo de duración del último ataque al corazón de los pacientes a partir de su edad. Luego, estudie las pruebas de hipótesis asociadas.
\end{enumerate}

\end{exercise}

\hypertarget{metricasRLS}{%
...
Lo anteriormente explicado se puede observar mediante los siguiente comandos, aunque es posible observarlos en salida general del comando \texttt{summary()}.
...
\item
  Obtenga de manera manual el estadístico F asociado a la prueba de hipótesis de nulidad conjunta de cada modelo. Interprete.
\item
  Compare los ajustes de ambos modelos utilizando el error estándar residual y el \(R^2\). Obtenga las métricas de manera manual. Interprete.
\end{enumerate}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-78-1} \end{center}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-82-1} \end{center}
...
\begin{exercise}
Utilizando la base de datos \protect\hyperlink{Ingreso}{Ingreso}, ajuste el modelo:
...
\begin{exercise}
Utilizando la base desdatos \protect\hyperlink{Pacientes}{Pacientes}, elabore un modelo para estudiar la variable \emph{oldpeak} a través de la variable \emph{chol}. Estudie los supuestos del modelo, utilizando una confianzza del 92\%.
\end{exercise}
...
\begin{example}
\protect\hypertarget{exm:MultipleManual}{}\label{exm:MultipleManual}Utilizando la base de datos \protect\hyperlink{Imacec3}{Imacec} , se debe considerar un modelo que estudie el valor del Imacec de Minería a base del Imacec de Industria y del Año de medición, con el fin de determinar los beta estimados, los valores ajustados y los errores del modelo, mediante las fórmulas explicadas anteriormente.
...
\hypertarget{covariables-cualitativas}{%
...
Utilizando la base de datos \protect\hyperlink{Pacientes}{Pacientes}, ajuste el siguiente modelo.
...
A diferencia del estadístico expresado en la ecuación \eqref{eq:estadistico-F-RLS}, la expresión es:
...
\item
  Estudie las hipótesis asociadas a los betas.
\end{enumerate}

\end{exercise}

\hypertarget{metricasRLM}{%
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"Y\_Gorro"} \OtherTok{=}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{Mineria, }\StringTok{"Residuos"} \OtherTok{=} \FunctionTok{residuals}\NormalTok{(modelo)),}
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Residuos, }\AttributeTok{y =}\NormalTok{ Y\_Gorro)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"Valores }\SpecialCharTok{\textbackslash{}n}\StringTok{ ajustados"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-96-1} \end{center}
...
\begin{center}\includegraphics{est2+inferencia_files/figure-latex/unnamed-chunk-98-1} \end{center}
...
\hypertarget{predicciuxf3n-de-observaciones}{%
\section{Predicción de observaciones}\label{predicciuxf3n-de-observaciones}}
...
\item
  Interprete los parámetros estimados.
\item
  Estudie las pruebas de hipótesis de no nulidad (individual y conjunta).
\item
...
\item
  Estudie los supuestos del modelo.
\end{enumerate}
...
\hypertarget{RLS-EMC}{%
\section{EMC en RLS}\label{RLS-EMC}}
...
\hypertarget{RLM-EMC}{%
\section{EMC en RLM}\label{RLM-EMC}}
...
Considerando la base de datos \protect\hyperlink{Ingreso}{Ingreso} y el modelo generado en el ejemplo \ref{exm:forward1}:
...
, los cuales, son los mismo a los visualizados en la salida del comando \texttt{anova()}.

\hypertarget{funciones}{%
\chapter{Funciones}\label{funciones}}

\hypertarget{funcion-indicatriz}{%
...
Sin embargo, la matriz \eqref{eq:matriz-colineal} tiene columnas linealmente dependientes, es decir, al menos una de ellas puede ser expresada como combinación lineal de las otras. En este caso, y a modo de ejemplo, es fácil ver qué
...
donde \(C_i\) indica la columna de la matriz. Esto implica, que no es posible calcular los estimadores de EMC expresados en la ecuación \eqref{eq:betasmultiple3-demostracion}, ya que, la matriz \((X^tX)\) no es invertible al darse este fenómeno de dependencia.
...
Se procede a escribir las ecuaciones de regresión para cada matriz (se omite la inclusión de los errores para facilitar la lectura), diferenciando simbólicamente los betas para cada ecuación. Tener en cuenta que los betas de cada ecuación dependen de las columnas consideradas, ya que al observar la matriz \eqref{eq:matriz-colineal}, se tienen tres betas ``originalmente'' (esto solo debe ser considerado como notación).
...
Cómo se puede observar, ambos esquemas deben dar como resultado la misma variable \(Y\). Esto es lo único similar entre ambos modelos, por lo cual, debe existir una relación entre ellos. El modelo correspondiente a la ecuación \eqref{eq:ecuacion-x1} expresa el efecto tanto del intercepto como el de la primera categoría de la variable cualitativa, mientras que el modelo asociado a la ecuación \eqref{eq:ecuacion-x2} expresa el efecto de la primera y segunda categoría de la variable cualitativa. Desarrollando las matrices de ambas ecuaciones se tiene lo siguiente.
...
\beta_2' \\
\end{pmatrix}
\label{eq:ecuacion-x2-1}
\end{equation}

Luego, igualando las matrices, y por ende, elemento con elemento, se tienen las siguientes expresiones \eqref{eq:ecuacion-x1-x2-1} y \eqref{eq:ecuacion-x1-x2-2}. Se puede observar, que en la ecuación \eqref{eq:ecuacion-x1-x2-2} el valor del intercepto asociado al modelo \eqref{eq:ecuacion-x1} es igual (``absorbe'') al efecto (``beta'') correspondiente a la segunda categoría de la variable cualitativa del modelo \eqref{eq:ecuacion-x2}, es decir, la categoría de referencia.
...
Por otro lado, respecto a la ecuación \eqref{eq:ecuacion-x1-x2-1} se observa que, al reemplazar \eqref{eq:ecuacion-x1-x2-2}, se tiene que \(\beta_2' + \beta_1 = \beta_1'\), por lo que el efecto propio de la primera categoría de la variable cualitativa (\(\beta_1'\)) es igual al valor del efecto propio de la segunda categoría más una diferencia, es decir, como afecta la primera categoría a la variable \(Y\) respecto a la categoría de referencia (que es la segunda categoría). Esta igualdad se puede expresar como el efecto superior o inferior (\(\beta_1\)) que tiene la primera categoría sobre el efecto directo de la segunda (\(\beta_2'\)). (\textbf{Nota:} estas relaciones son válidas tanto para los parámetros como para sus estimadores).
...
\tightlist
\item
  Observando el modelo modelo \eqref{eq:modelo-x1-ejemplo}:
...
la cual, debería ser implementada manualmente en R, aunque existen ciertos softwares como \href{https://www.sas.com/es_cl/home.html}{SAS}, que tiene opciones para implementar este tipo de matrices de diseño.
