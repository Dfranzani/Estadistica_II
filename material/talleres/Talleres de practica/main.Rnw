...
# knitr::opts_chunk$set(fig.path = "~/material/talleres/Talleres de practica/figures/")
knitr::opts_chunk$set(fig.path="/home/daniel/MEGA/Programación/Trabajos en R/Bookdown/Cursos de Estadística/Estadística II/material/talleres/Talleres de practica/figures")
@
