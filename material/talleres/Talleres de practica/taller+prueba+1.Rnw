\begin{center}
{\bf \Large{Taller de práctica Prueba 1}}\\Intervalos de confianza (sección 1)\\Conceptos de pruebas de hipótesis (sección 2.1)
\end{center}

\subsection*{Parte 1: Intervalos de confianza en R}
...
\subsection*{Parte 2: Conceptos de pruebas de hipótesis e IC}
