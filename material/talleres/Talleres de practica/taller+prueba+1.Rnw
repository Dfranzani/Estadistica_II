...
Para los siguiente enunciados, construya e interprete el intervalo de confianza correspondiente. Utilice alguna de las tablas al final del documento, según estime conveniente (al buscar, utilice el valor que más se aproxime).
  \begin{enumerate}
