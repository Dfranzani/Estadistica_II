...
Con la siguiente salida es de 10 valores aleatorios de la base de datos explicada en la sección de \textbf{Inferencia}. Asumiendo que las variables tiene distribución normal y son independientes, realice lo siguiente:
...
@
  ...
  \begin{enumerate}
    \item Una prueba de hipótesis para determinar si la media del 2014 es menor a 13000 miles de millones de pesos. Utilice un nivel de significancia del 5\%, y considere una desviación estándar poblacional 17210.14. Interprete utilizando el método del valor crítico (asuma que $Z_{0.05} = -1.6448$).
    \item Una prueba de hipótesis para determinar si la media del 2013 es mayor a 9000 miles de millones de pesos. Utilice un nivel de significancia del 10\%, y considerando una varianza poblacional de 453794323.  Interprete utilizando el método del valor crítico (asuma que $Z_{1-0.1} = 1.2815$).
  \end{enumerate}
...
@
  \begin{enumerate}
    \item Una prueba de hipótesis para determinar si la media del 2013 es diferente a la media del 2014, considerando desviaciones estándar poblacionales de 16922.05 17210.14 respectivamente. Utilice un nivel de significancia del 5\%. Interprete utilizando el método del intervalo de confianza (asuma que $Z_{1-0.05/2} = 1.9599$).
    \item (Trabajo independiente) Una prueba de hipótesis para determinar si la media del 2013 es mayor a 9000 miles de millones de pesos. Utilice un nivel de significancia del 10\%.  Interprete utilizando el método del valor crítico (asuma que $t_{1-0.1, k = 9} = 1.3830$).
    \item (Trabajo independiente) Una prueba de hipótesis para determinar si la diferencia entre media del 2013 y la media del 2014 es menor a 5 miles de millones de pesos. Utilice un nivel de significancia del 3\%. Considere varianzas poblacionales desconocidas e iguales. Interprete utilizando el método del intervalo de confianza (asuma que $t_{0.03, k = 18} = -2.0070$).
  \end{enumerate}
\end{enumerate}
