...
\date{Actualizado al 17-11-2025}
...
Calcule los EMC, mostrando explícitamente los cálculos de \(X^tX\), \(X^tY\), \((X^tX)^{-1}\) y finalmente el vector de estimadores \(\hat\beta\); obtenga los valores ajustados \(\hat Y=X\hat\beta\). Calcule la matriz de residuos. Calcule las SCT, SCReg, SCR, el MCE, el estadístico \(F_0\) y el error estándar residual.
\end{exercise}
